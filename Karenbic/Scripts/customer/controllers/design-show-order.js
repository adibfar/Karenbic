            ...
            $scope.sendReview = function () {
                ...
                if ($scope.acceptedFile == null &&
                    ...
                    ngDialog.open({
                        template: '<div style="font-family:yekan;font-size:14px;">' +
                            '<p>' +
                            'تأیید طرح روبرو از جانب شما به منزله اتمام مراحل طراحی برای این سفارش می باشد ' +
                            ...
                            '</p>' +
                            '<p>' +
                            'لازم به ذکر است که در صورت عدم اتمام روند پرداخت به هر دلیل نظر شما در سیستم ثبت نشده و می بایست مراحل را از ابتدا انجام دهید.' +
                            '</p>' +
                            '<div style="text-align:left;">' +
