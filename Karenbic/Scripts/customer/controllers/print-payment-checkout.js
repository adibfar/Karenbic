/**=========================================================
 * Module: print-payment-checkout.js
 * Show Paid Factor
 =========================================================*/

App.controller('PrintPaymentCheckoutController', ['$scope', '$http', 'APP_BASE_URI', 'toaster', '$stateParams',
    function ($scope, $http, baseUri, toaster, $stateParams) {
        ...
        $scope.fetchData = function () {
            ...
            $http.get(baseUri + 'PrintPayment/GetCheckoutData', {
                params: {
