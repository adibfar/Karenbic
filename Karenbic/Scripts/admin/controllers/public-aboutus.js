App.controller('Public_AboutUsController', ['$scope', '$http', 'APP_BASE_URI', 'toaster', '$modal', 'ngDialog',
    function ($scope, $http, baseUri, toaster, $modal, ngDialog) {
        ...
        $scope.fetchText = function () {
            ...
            $http.get(baseUri + 'PublicContent/AboutUsText')
        ...
        $scope.save = function () {
            ...
            $http.post(baseUri + 'PublicContent/AboutUsText',
            {
                text: $scope.text
            }).
            success(function (data, status, headers, config) {
