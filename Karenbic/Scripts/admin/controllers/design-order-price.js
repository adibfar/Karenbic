App.controller('DesignOrderPriceController', ['$scope', '$http', 'APP_BASE_URI', 'toaster', '$modal', 'ngDialog',
    function ($scope, $http, baseUri, toaster, $modal, ngDialog) {
        ...
        $scope.fetchPrices = function () {
            ...
            $http.get(baseUri + 'DesignOrderPrice/Get', {
                params: {
        ...
        var AddPriceCtrl = ['$scope', '$http', '$modalInstance', 'formGroup', 'form', function ($scope, $http, $modalInstance, formGroup, form) {
            ...
            $scope.send = function () {
                ...
                $http.post(baseUri + 'DesignOrderPrice/Add',
                {
                    formId: $scope.form.Id,
                    ...
                    prepayment: $scope.newPrice.Prepayment,
                    specialCreativityPrice: $scope.newPrice.SpecialCreativityPrice,
                    specialCreativityPrepayment: $scope.newPrice.SpecialCreativityPrepayment
                }).
                success(function (data, status, headers, config) {
        ...
        $scope.remove = function (index) {
            ngDialog.open({
                ...
                preCloseCallback: function (value) {
                    ...
                    $scope.fetchLoading = true;
                    $http.post(baseUri + 'DesignOrderPrice/Remove',
                    {
