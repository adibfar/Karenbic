App.controller('PrintFactorTextController', ['$scope', '$http', 'APP_BASE_URI', 'toaster', '$modal', 'ngDialog',
    function ($scope, $http, baseUri, toaster, $modal, ngDialog) {
        ...
        $scope.fetchText = function () {
            ...
            $http.get(baseUri + 'FactorOfPrintOrder/GetFactorText')
        ...
        $scope.save = function () {
            ...
            $http.post(baseUri + 'FactorOfPrintOrder/SetFactorText',
            {
                text: $scope.text
            }).
            success(function (data, status, headers, config) {
