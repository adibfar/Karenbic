/**=========================================================
 * Module: print-payment-list.js
 * Show Print Payment List
 =========================================================*/

App.controller('PrintPaymentListController', ['$scope', '$http', 'APP_BASE_URI', 'toaster', '$modal',
    function ($scope, $http, baseUri, toaster, $modal) {
        ...
        $scope.fetchPayments = function (pageIndex) {
            ...
            $http.get(baseUri + 'PrintPayment/Get', {
                params: {
